...
summary: End-to-end design and control of a 6-DOF mobile manipulator with ROS2 simulation, kinematics validation, and high-accuracy pick-and-place.
...
impact: 98% pick-and-place accuracy in simulated workflows
featured: false
