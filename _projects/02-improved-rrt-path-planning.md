...
summary: A faster bi-directional RRT* planner with heuristics and post-processing to generate shorter, smoother paths in dynamic environments.
github_url: https://github.com/vishnumandala/Improved-Bi-directional-RRT-Algorithm-for-Robot-Path-Planning-
role: Robotics Algorithms Engineer
duration: Jan 2023 - Apr 2023
impact: 10-30% shorter paths and up to ~50% faster planning in simulation
featured: true
