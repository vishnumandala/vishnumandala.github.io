...
summary: Mobile diagnostic workflow combining ensemble deep learning and TensorFlow Lite for fast skin lesion classification on-device.
github_url: https://github.com/vishnumandala/MyDerma-Mobile-Deep-Learning-for-Real-Time-Skin-Cancer-Detection
role: Applied ML Engineer
duration: Sep 2023 - Dec 2023
impact: 97.15% ensemble test accuracy
featured: false
