...
summary: Adaptive neural controller design for nonlinear systems with online learning and Lyapunov-based stability guarantees.
github_url: https://github.com/vishnumandala/Technical-Analysis-and-Simulation-of-Adaptive-Neural-Control-Systems
role: Control Systems Engineer
duration: Jul 2023 - Oct 2023
impact: 25% faster response and 40% lower tracking error in simulations
featured: false
