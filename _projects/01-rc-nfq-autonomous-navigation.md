...
summary: Deep RL navigation research adapting RC-NFQ with CNN + dropout regularization for improved policy stability in highway scenarios.
...
impact: Competitive reward and episode stability vs baseline DQN
featured: true
