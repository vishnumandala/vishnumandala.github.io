...
summary: Real-time obstacle detection and recognition pipeline built on customized YOLOv8 for safer autonomous mobile robot navigation.
github_url: https://github.com/vishnumandala/Obstacle-Detection-and-Recognition-System-using-Customized-YOLO-Algorithm-for-a-Mobile-Robot
role: Perception Engineer
duration: Mar 2023 - May 2023
impact: ~92% mAP with ~20 FPS inference performance
featured: false
